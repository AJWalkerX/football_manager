...
public class MatchStats extends BaseEntity{
    ...
    public MatchStats(DatabaseModel databaseModel,int matchId) {
        super.id=databaseModel.matchStatsDB.findAll().size()+1;
        this.matchId=matchId;
        databaseModel.matchStatsDB.save(this);
